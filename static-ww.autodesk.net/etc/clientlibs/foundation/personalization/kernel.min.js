...
CQ_Analytics.PersistedJSONStore.registerNewInstance("usersetlocation",{});
window.adsk=window.adsk||{};
...
a.getCommonLoginUrl=function(b){return b?b+adsk.oxygen.common.getCommonLoginPath():location.protocol+"//"+location.host+adsk.oxygen.common.getCommonLoginPath()
};
a.getCommonRegisterPath=function(){return adsk.oxygen.common.MAIN_OXYGEN_URL+adsk.oxygen.common.OXYGEN_REGISTER_URL
};
a.getCommonRegisterUrl=function(b){return b?b+adsk.oxygen.common.getCommonRegisterPath():location.protocol+"//"+location.host+adsk.oxygen.common.getCommonRegisterPath()
};
a.amILoggedIn=function(){return adsk.oxygen.common.getVisitorEmail()&&adsk.oxygen.common.getVisitorEmail().length>4?true:false
};
a.getVisitorEmail=function(){var b=adsk.oxygen.common.getLoggedUserProfile();
return typeof b!=="undefined"&&b!==null?b.email:undefined
};
a.getVisitorName=function(){var b=adsk.oxygen.common.getLoggedUserProfile();
if(typeof b!=="undefined"){if(b.fullname&&b.fullname.length>0){return b.fullname
}else{return b.firstname&&b.lastname?b.firstname+" "+b.lastname:""
}}};
a.getLoggedUserProfile=function(){var b;
if(window.sessionStorage&&typeof window.sessionStorage.profile!=="undefined"){try{b=JSON.parse(window.sessionStorage.profile)
}catch(c){}}return b
};
return a
}(adsk.oxygen.common||{}));